...
This module implements TVAE for generating synthetic tabular medical data
...
OUTPUT_PATH = '../data/synthetic/tvae.csv'
RANDOM_SEED = 42
...
def train_tvae(df, metadata):
    """
    Train TVAE model on training data.
...
def generate_synthetic_data(synthesizer, num_samples):
    ...
    Args:
        synthesizer: Trained TVAESynthesizer
...
def main():
    ...
    # Train TVAE
    synthesizer = train_tvae(train_df, metadata)
    ...
    print("\n" + "="*60)
    print("TVAE generation complete!")
    print("="*60)
